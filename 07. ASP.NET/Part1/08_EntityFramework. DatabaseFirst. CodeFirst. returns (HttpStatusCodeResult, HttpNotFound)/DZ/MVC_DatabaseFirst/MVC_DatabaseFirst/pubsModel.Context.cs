...
namespace MVC_DatabaseFirst
{
    ...
    public partial class pubsEntities : DbContext
    {
        ...
        public virtual int AvgPriceByState(string st, ObjectParameter m)
        {
            var stParameter = st != null ?
                new ObjectParameter("st", st) :
                new ObjectParameter("st", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AvgPriceByState", stParameter, m);
        }
    }
}
