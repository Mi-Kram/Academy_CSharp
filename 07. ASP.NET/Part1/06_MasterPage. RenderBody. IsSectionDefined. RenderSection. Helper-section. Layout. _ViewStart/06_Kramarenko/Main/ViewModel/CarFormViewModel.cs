...
using static Main.Controllers.HWController;
...
namespace Main.ViewModel
{
  public class CarFormViewModel
  {
    ...
    [CarTypeCheck(ErrorMessage = "Please, choose car's type.")]
    [Range(1, 4, ErrorMessage = "Please, choose car's type.")]
    public int TypeID { get; set; }

    [Required(ErrorMessage = "Please, choose car's image.")]
    [Remote("ValidateFiles", "Auth", HttpMethod = "POST", ErrorMessage = "Please, choose car's image.")]
