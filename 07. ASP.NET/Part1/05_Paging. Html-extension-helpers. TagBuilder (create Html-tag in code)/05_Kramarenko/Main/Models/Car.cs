...
namespace Main.Models
{
  ...
  public static class CarTestClass
  {
    public static List<Car> GetCars()
    {
      ...
      result.Add(new Car { ID = 3, Brand = "Volkswagen", Model = "B", Price = 8000, Speed = 215, Date = new DateTime(1995, 1, 1), Type = new CarType(4), ImgSrc = "Images/Cars/3.jpg" });
      ...
      result.Add(new Car { ID = 5, Brand = "Honda", Model = "B", Price = 12000, Speed = 280, Date = new DateTime(2009, 1, 1), Type = new CarType(4), ImgSrc = "Images/Cars/5.jpg" });
      ...
      result.Add(new Car { ID = 11, Brand = "Honda", Model = "D", Price = 10000, Speed = 300, Date = new DateTime(2003, 1, 1), Type = new CarType(4), ImgSrc = "Images/Cars/11.jpg" });

      #region Test

      for(int i = 0; i < result.Count; i++)
			{
        result[i].Type = new CarType(1+(i%3));
			}
