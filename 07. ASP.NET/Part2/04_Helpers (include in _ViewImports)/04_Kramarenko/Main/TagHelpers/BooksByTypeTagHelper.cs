...
{
	public class BooksByTypeTagHelper : TagHelper
	{
        ...
        {
            if (Page < 1) Page = 1;
            string HTMLcontent = $"<thead><tr><th><a style='text-decoration: none; color: #000; display: block;' href={SortFunc("Title", (OrderColumn == "Title" ? !OrderAsc : true))}'>Title</a></th><th><a style='text-decoration: none; color: #000; display: block;' href={SortFunc("Price", (OrderColumn == "Price" ? !OrderAsc : true))}'>Price</a></th><th>Type</th></tr></thead><tbody>";

            var books = BookList.Where(x => x.Type.Trim(' ') == Type);
